...
def test_reset_password_success(mocker, client, mock_user):
    ...
    mocker.patch.object(
        user_service, "generate_reset_link", return_value="mocker_reset_link"
    )
...
def test_confirm_password_too_short(mocker, client):
    ...
    payload = {"token": "valid_token", "new_password": "ab", "confirm_password": "ab"}
